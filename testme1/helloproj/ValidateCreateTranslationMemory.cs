...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The ValidateCreateTranslationMemory recording.
    /// </summary>
    [TestModule("c2dc8fbb-b49c-4624-b8de-4d17771763e1", ModuleType.Recording, 1)]
    public partial class ValidateCreateTranslationMemory : ITestModule
    {
        /// <summary>
        ...
        static ValidateCreateTranslationMemory instance = new ValidateCreateTranslationMemory();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public ValidateCreateTranslationMemory()
        {
        }
        ...
        /// </summary>
        public static ValidateCreateTranslationMemory Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='Translation Memories') on item 'SYSTRANDictionaryManager.SdmWindowOpen.TranslationMemories1'.", repo.SYSTRANDictionaryManager.SdmWindowOpen.TranslationMemories1Info, new RecordItemIndex(2));
            Validate.Attribute(repo.SYSTRANDictionaryManager.SdmWindowOpen.TranslationMemories1Info, "Text", "Translation Memories");
            Delay.Milliseconds(100);
